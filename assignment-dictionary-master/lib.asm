...
;Принимает указатель на нуль-терминированную строку и дескриптор вывода для stderr и направляет
;эти данные в функцию print_str.
;Параметры:
;	rdi: указатель на нуль-терминированную строку
;	r8: дескриптор вывода
;Вывод:
;	!stdout
print_error:
	mov r8, 2			;stderr file descriptor
	jmp print_str			;Переход на функцию print_str
    	
;Принимает указатель на нуль-терминированную строку и дескриптор вывода для stdout и направляет
;эти данные в функцию print_str.
;Параметры:
;	rdi: указатель на нуль-терминированную строку
;	r8: дескриптор вывода
...
;	!stdout
print_string:
	mov r8, 1			;stdout file descriptor
